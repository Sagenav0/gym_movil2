...
@Component({
  selector: 'app-cambiar-contra-olvidada',
  templateUrl: './cambiar-contra-olvidada.page.html',
  styleUrls: ['./cambiar-contra-olvidada.page.scss'],
})
export class CambiarContraOlvidadaPage implements OnInit {
