...
export class ConexionService {
  ...
  get refresh$(){
   ...
   // url = "http://192.168.246.128:9501" // Dirección de backend para usar como servidor 
  ...
  Rutinas(formattedFecha:string):Observable<any>{
    return this.http.get(`${this.url}/rutinas/${formattedFecha}`);
  }
}
